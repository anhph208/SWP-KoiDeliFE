        ...
        >
          <Box>
            ...
            <Typography sx={{ fontWeight: "bold" }}>
              Tổng số lượng cá: {totalQuantity}
            </Typography>
          </Box>
          <Box>
            {isEditing && (
        ...
        <Paper sx={{ padding: 2, flex: 1, margin: 1, textAlign: "start" }}>
          <TableContainer component={Paper} sx={{ marginTop: 2 }}>
            <Table>
              <TableHead>
                <TableRow>
                  <TableCell sx={{ bgcolor: "rgb(241 141 154 / 87%)" }}>
                    Kích thước
                  </TableCell>
                  <TableCell sx={{ bgcolor: "rgb(241 141 154 / 87%)" }}>
                    Số lượng
                ...
                boxOption.map((boxOption) => (
                  <TableRow key={boxOption.boxOptionId}>
                    ...
                    <TableCell align="right">
                      {boxOption.boxName && boxOption.boxName.includes("JP")
